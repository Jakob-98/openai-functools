...
def generate_spoof_api_response(
    vm_id: str, endpoint: str, params: Dict[str, Any] = None
) -> Dict[str, Any]:
    """
...
def generate_spoof_vector_db_response(query) -> str:
    ...
    # Simulated response
    response = (
        f"Error Code ERR001 is a critical alert indicating an Internal Server Error. "
